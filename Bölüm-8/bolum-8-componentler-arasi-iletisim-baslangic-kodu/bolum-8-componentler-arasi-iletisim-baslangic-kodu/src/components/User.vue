<template>
  <div class="container">
    ...
    <p>Child Componenet gelen veri :  {{childData}}</p>
    <hr>
    <div class="row">
      <app-user-detail @data="childData = $event" @ageData="age = $event" :name="title"></app-user-detail>
...
<script>
  ...
  export default {
    ...
    data : function(){
      return {title : "Ahmet", childData : "", age : "25"}
    },
    methods : {
      changeName(){
        this.title = "Can"
